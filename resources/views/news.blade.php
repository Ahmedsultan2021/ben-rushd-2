...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            <section style="background-color: #F0F2F5;" class="mb-5">
                <div class="container py-5">
                  <div class="main-timeline-2">
                    <div class="timeline-2  left-2">
                      <div class="card" style="background-color: white;border-radius: 20px">
                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(135).webp" style="width: 100%; border-radius: 20px 20px 0px 0px" class="card-img-top"
                          alt="Responsive image">
                        <div class="card-body p-4">
                          <h4 class="fw-bold mb-1">Ut enim ad minim veniam</h4>
                          <p class="text-muted mb-1"> <i class="far fa-clock"></i> 2017</p>
                    ...
                    <div class="timeline-2 left-2">
                      <div class="card">
                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(129).webp" style="width: 100%" class="card-img-top"
                          alt="Responsive image">
                        <div class="card-body p-4">
                    ...
                    <div class="timeline-2 left-2">
                      <div class="card">
                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(131).webp" style="width: 100%" class="card-img-top"
                          alt="Responsive image">
                        <div class="card-body p-4">
                    ...
                    <div class="timeline-2 right-2">
                      <div class="card">
                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(125).webp" style="width: 100%" class="card-img-top"
                          alt="Responsive image">
                        <div class="card-body p-4">
                    ...
                    <div class="timeline-2 left-2">
                      <div class="card">
                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(144).webp" style="width: 100%" class="card-img-top"
                          alt="Responsive image">
                        <div class="card-body p-4">
