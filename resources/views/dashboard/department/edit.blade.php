                            ...
                            @endif
                                <form action="{{ route('department.update',["department"=>$department->id]) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" value="{{old('brief')}}" > {{$department->brief}}</textarea>
                                    @error('brief')
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="image" value="{{$department->image}}" class="custom-file-input @error('image') is-invalid @enderror" id="exampleInputFile">
